...
setup(
  ...
  description = 'A package that allows you to implement C++ data structures in Python.',   # Give a short description about your library
  ...
  download_url = 'https://github.com/tinyCodersDen/py-data-structure/archive/refs/tags/v_01.tar.gz',    # I explain this later on
